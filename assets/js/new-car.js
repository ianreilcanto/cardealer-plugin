 jQuery(function() {
   ...
   jQuery( "#slider-newCar" ).slider({
      ...
      create: function( eveny, ui){
          ...
          jQuery("#label-newCar").html("Insats: "+labelArr[0]);
      ...
      slide: function( event, ui ) {
          ...
          // jQuery( "#days" ).val( ui.value );
          jQuery("#label-newCar").html("Insats: "+labelArr[ui.value]);
   ...
   jQuery( "#slider1-newCar" ).slider({
      value:4,
      min: 0,
      max: 6,
      step: 1,
      create: function( eveny, ui){
          jQuery("#label-lånetid").html('Lånetid: ' +labelArr1[4]);
  ...
  jQuery( "#slider2-newCar" ).slider({
    value:2,
    min: 0,
    max: 5,
    step: 1,
    create: function( eveny, ui){
         jQuery("#label-restvärde").html("Restvärde: "+labelArr2[2]);
  ...
  jQuery( "#days" ).val(jQuery( "#slider" ).slider( "value" ) );
  jQuery("#label-newCar").html(labelArr[jQuery( "#slider" ).slider( "value" )]);
